...
const Services = () => {
  ...
  return (
    <section id="services" ref={sectionRef} className="section-padding relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-design-dark via-black to-design-dark"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl md:text-4xl font-bold mb-4 reveal" data-delay="1">Mes Expertises</h3>
